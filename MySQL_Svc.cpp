...
void MySQL_Svc::Connect(const Context& c)
{
...
bool MySQL_Svc::MySQL_Reconnect()
...
void MySQL_Svc::Lookup_column(const Context& c)
...
void MySQL_Svc::Query(const Context& c)
...
void MySQL_Svc::Insertdatapath(const Context& c)
...
void MySQL_Svc::Insertdatacode(const Context& c)
{
 if(IfConnect())
 {
  CreateStmt();
